...
# [5.13.0](https://github.com/luojunbin/loadable-components/compare/v5.11.0...v5.13.0) (2020-08-26)


### Bug Fixes

* **component:** wrong server enviroment condition ([22e2713](https://github.com/luojunbin/loadable-components/commit/22e2713855394a1689b715defe8fcf065b8c3a14))


### Features

* **server:** server 修改依赖 ([660690b](https://github.com/luojunbin/loadable-components/commit/660690bd3033a35d2bdcc409b33a9effeeb9e0f4))
* add `.idea` to .gitignore ([e3d6928](https://github.com/luojunbin/loadable-components/commit/e3d69283076c23051bec8163f436ff1fea5b3dad))
* passing chunkName and extractor to Component ([1fc9d8c](https://github.com/luojunbin/loadable-components/commit/1fc9d8cf2a639af2c8e7e0bc2ad73432ca16796e))
